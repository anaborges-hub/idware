          ...
          <div className="flex flex-col items-center text-center">
            <div className="mb-8 relative">
              ...
              <p className="text-2xl md:text-4xl font-display leading-tight font-medium relative z-10">
                "ID-ware transformed how we manage access across our 45 global offices. We reduced badge provisioning time by 90% and finally achieved 100% audit compliance."
              </p>
            </div>
